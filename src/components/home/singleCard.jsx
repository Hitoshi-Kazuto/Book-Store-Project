...
const singleCard = ({ book , index}) => {
    return (
        ...
        <div className='border-2 border-gray-500 rounded px-4 py-2 m-4 relative hover:shadow-xl'>
            <h2 className='absolute top-1 right-2 px-4 py-1 mx-0 my-1 bg-purple-200 rounded-xl'>
                {book.publishYear}
            </h2>
